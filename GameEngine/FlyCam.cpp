...
//FlyCam::FlyCam(int camWidth, int camHeight, glm::vec3 camLocation) {
//	this->camWidth = camWidth;
//	this->camHeight = camHeight;
//	this->camLocation = camLocation;
//}
//
//void FlyCam::cameraMatrix(float FOVdeg, float nearPlane, float farPlane, GLuint shaderProgram, const char* uniform) {
//	glm::mat4 view = glm::mat4(1.0f);
//	glm::mat4 projection = glm::mat4(1.0f);
//	glm::mat4 model = glm::mat4(1.0f);
//
//	view = glm::lookAt(camLocation, camLocation + camOrientation, camUpVector);
//	projection = glm::perspective(glm::radians(FOVdeg), (camWidth / (float)camHeight), nearPlane, farPlane);
//	glUniformMatrix4fv(glGetUniformLocation(shaderProgram, uniform), 1, GL_FALSE, glm::value_ptr(projection * view * model));
//}
//
//void FlyCam::camControls(GLFWwindow* window) {
//
//	if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS) {
//		camLocation.y += camSpeed/* * camOrientation*/;
//	}
//	if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS) {
//		camLocation.y -= camSpeed /** camOrientation*/;
//	}
//	if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS) {
//		camLocation.x -= camSpeed /** glm::normalize((glm::cross(camOrientation, camUpVector)))*/;
//	}
//	if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS) {
//		camLocation.x += camSpeed /** glm::normalize((glm::cross(camOrientation, camUpVector)))*/;
//	}
//	if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS) {
//		camLocation += camSpeed * camUpVector;
//	}
...
//		float rotX = camSensi * (float)(mouseX - (camHeight / 2)) / camHeight;
//		float rotY = camSensi * (float)(mouseY - (camHeight / 2)) / camHeight;
//
//		glm::vec3 newOrientation = glm::rotate(camOrientation, glm::radians(-rotX), glm::normalize(glm::cross(camOrientation, camUpVector)));
//
//		if (!((glm::angle(newOrientation, camUpVector) <= glm::radians(5.0f) or glm::angle(newOrientation, -camUpVector) <= glm::radians(5.0f)))) {
//			camOrientation = newOrientation;
//		}
//
//		camOrientation = glm::rotate(camOrientation, glm::radians(-rotY), camUpVector);
//		glfwSetCursorPos(window, (camWidth / 2), (camHeight / 2));
//	}
